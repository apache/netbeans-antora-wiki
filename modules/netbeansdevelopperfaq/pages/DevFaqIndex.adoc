...
:toc-title:
:page-syntax: true
:page-aliases: ROOT:wiki/DevFaqIndex.adoc
include::front::partial$database.adoc[]

//== Actions: How to add things to Files, Folders, Menus, Toolbars and more
// dzone link:{webarchive}20170617115833/http://netbeans.dzone.com/news/which-netbeans-platform-action|
// dzone link:{webarchive}20170617115833/http://netbeans.dzone.com/how-to-make-context-sensitive-actions
...
// Saving as per link:{webarchive}20170110010149/http://wiki.netbeans.org/NetBeansDeveloperFAQ#Saving
// 
//== Project Types
