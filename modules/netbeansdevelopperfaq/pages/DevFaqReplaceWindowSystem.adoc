...
:page-position: 14
:page-aliases: ROOT:wiki/DevFaqReplaceWindowSystem.adoc
...
Before doing this you should know that starting with NetBeans 6.5, it xref:front::blogs/geertjan/limiting_the_netbeans_window_system.adoc[will be easy to change certain behaviors of the window system].  So needing to replace the window manager is rare already and will be needed even less often in the future.
