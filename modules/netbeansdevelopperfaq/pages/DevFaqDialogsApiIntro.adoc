...
:page-position: 1
:page-aliases: ROOT:wiki/DevFaqDialogsApiIntro.adoc
...
The link:{apidoclink}org-openide-dialogs/[Dialogs API] provides support for dialogs and wizards.
...
And finally, the DialogDescriptor subclass, handles complex cases (there are many variants here; see link:{apidoclink}org-openide-dialogs/org/openide/DialogDescriptor.html[Dialog Descriptor's Javadoc] for details):
