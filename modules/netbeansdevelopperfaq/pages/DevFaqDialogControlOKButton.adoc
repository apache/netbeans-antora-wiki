...
:page-position: 2
:page-aliases: ROOT:wiki/DevFaqDialogControlOKButton.adoc

include::front::partial$database.adoc[]

The link:{apidoclink}org-openide-dialogs/overview-summary.html[NetBeans Dialogs API] makes it easy to create consistent dialogs that behave as users would expect.  But since you don't directly create the OK button, it may not be obvious how you can enable it or disable it.
