...
:page-position: 5
:page-aliases: ROOT:wiki/DevFaqSampleCode.adoc
...
The `platform/samples/` folder can be link:http://hg.netbeans.org/main/misc/file/tip/platform/samples/[browsed online here]. But for really trying things out it is usually more useful to xref:wiki::wiki/HgHowTos.adoc[have a local copy] - then you can open them as projects in the IDE.
