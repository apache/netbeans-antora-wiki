...
xref:tutorial::kb/docs/java/maven-dependencies-screencast.adoc[Working with Maven
...
* xref:tutorial::kb/docs/java/maven-dependencies-screencast.adoc[Video of Working with Maven Dependencies]
