...
* xref:./DevFaqIndex.adoc[NetBeans User FAQ] - Installation, configuration, packs, usage, community.

* xref:./FaqArchive.adoc[FAQ Archive] - Questions and answers for NetBeans IDE 5.5 or older

=== FAQs for specific technologies

* xref:./NetBeansDeveloperFAQ.adoc[NetBeans Platform Developer FAQ] - NetBeans plugins and rich-client applications
...
* xref:./NBIFAQ.adoc[NetBeans Installer FAQ]
