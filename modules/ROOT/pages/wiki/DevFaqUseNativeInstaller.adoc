...
Using xref:./DevFaqModulesGeneral.adoc[META-INF/services] or (in NetBeans 6.9) the `@ServiceProvider` annotation (see xref:../blogs/geertjan/meta_inf_services_vs_layer.adoc[Geertjan's blog for more info]):
