...
link:{apidoclink}org-openide-loaders/org/openide/loaders/DataObject.html[Data
...
link:{apidoclink}org-openide-loaders/org/openide/loaders/DataObject.html[javadoc]).
...
link:{apidoclink}org-netbeans-modules-project-ant/org/netbeans/api/project/ant/AntArtifact.html[AntArtifact]
...
Another example from NetBeans is the link:https://github.com/apache/netbeans/tree/master/platform//openide/src/org/openide/filesystems/FileObject.java?content-type=text/plain[ FileObject ] (part of the link:{apidoclink}org-openide-filesystems/org/openide/filesystems/doc-files/api.html[filesystem API]). This type usage seems very close to the TopManager example (but is not as obvious): There are very few people directly subclassing `FileObject` (javadoc's HttpFileSystem, Kyley and Niclas) and tons of client API users (every NetBeans module).
